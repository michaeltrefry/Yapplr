...
{
    Task<IEnumerable<TagDto>> SearchTagsAsync(string query, int? currentUserId = null, int limit = 20);
    ...
    Task<TagDto?> GetTagByNameAsync(string tagName, int? currentUserId = null);
}
