...
import { Home, Search, LogOut, Settings, MessageCircle, Bell, TestTube, TrendingUp, Shield, Users, Compass } from 'lucide-react';
      ...
      <div className="flex flex-col h-full">
        ...
        <nav className="flex-1 flex flex-col space-y-2 min-h-0">
          ...
          >
            ...
            <span className="text-lg hidden lg:block">Discovery</span>
          </Link>
