        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-900 group-hover:text-blue-600">Twitter</span>
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-900 group-hover:text-blue-600">Facebook</span>
              <ExternalLink className="w-4 h-4 text-gray-400 group-hover:text-blue-500" />
            </button>
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-900 group-hover:text-blue-600">LinkedIn</span>
              <ExternalLink className="w-4 h-4 text-gray-400 group-hover:text-blue-500" />
            </button>
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-900 group-hover:text-orange-600">Reddit</span>
